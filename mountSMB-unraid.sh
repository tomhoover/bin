...
USERNAME=${MOUNT_unraid_USERNAME:-$USERNAME}	#  set the variable MOUNTSMB_USERNAME in ~/.SECRETS

# Password for server, check notes
PASSWORD="password"				# you can set your password here, or
PASSWORD=${MOUNT_unraid_PASSWORD:-$PASSWORD}	#  set the variable MOUNTSMB_PASSWORD in ~/.SECRETS
...
SHARES="backups Media%20-%20Originals Movies TV%20Shows Vault"
