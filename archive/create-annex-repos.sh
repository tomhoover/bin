...
echo "===== Creating $1 git-annex repositories ====="
echo ""
echo "     ariel..."
cd ~/annex && mkdir "$1" && cd "$1" && pwd && git init && git annex init ariel
echo "     RAID10..."
cd /Volumes/RAID10/annex && mkdir "$1" && cd "$1" && pwd && git init && git annex init RAID10
echo "     unraid..."
