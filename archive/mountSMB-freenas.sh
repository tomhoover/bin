...
USERNAME=${MOUNT_freenas_USERNAME:-$USERNAME}	#  set the variable MOUNTSMB_USERNAME in ~/.SECRETS

# Password for server, check notes
PASSWORD="password"				# you can set your password here, or
PASSWORD=${MOUNT_freenas_PASSWORD:-$PASSWORD}	#  set the variable MOUNTSMB_PASSWORD in ~/.SECRETS
